                ...
                <div class="row">
                    <div id="searchPart">
                        ...
                        <div id="refreshPart">
                            ...
                            <!--分页标签-->
                            <div class="footer page" style="padding-left: 44%">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>小主请三思!</h4>
                    <p>删除的图文泼出去的水,找不回来了啊囧</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">取 消</button>
                    <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="infoDelete()" >确 定</button>
                </div>
            </div>
        </div>
    </div>
